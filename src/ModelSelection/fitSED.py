...
#ps=param5.SetFitSedParams('/Users/anneya/PySEDfit/test.param')#'/Users/anneya/PySEDFit/Testfiles/testmakebbsed.param')
#a=main(ps)
#params=ps

ps=param5.SetFitSedParams('/Users/anneya/gzhk/forPySEDfit/test.param')
...
if params['mcits']!=1 and params['oldschoolmc']==True:
    ...
    dataFlux = mcDataFlux
    dDataFlux = np.ones(np.shape(dataFlux))
